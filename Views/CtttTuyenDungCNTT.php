<!-- <div class="d-flex justify-content-center align-items-center min-vh-100 box-area2 " style="font-family:'Edu NSW ACT Foundation';"> -->
    <div class="row border rounded-2 p-0 bg-while shadow box-area3 mx-auto">
        
        <!-- <div class="row box"> -->
            <div class="col-md-8 ">
                <h2 class="pn-title pn-title-page">Tuyển dụng</h2>
            ...
            <div class="col-md-4">
                <div class="pn-video">
                    ...
                    <div class="pn-iframe-video pn-item active" data-id="hQJ_oLsiqSs"> 
                    <iframe src="https://www.youtube.com/embed/hQJ_oLsiqSs?autoplay=1" frameborder="0" height="197" allow="" allowfullscreen=""  width="100%"></iframe>
                ...
                <div class="pn-news " >
                    ...
                    <div class="pn-wrapper-item ">
                            <div class="pn-item clearfix d-flex mb-3  justify-content-center">
                        <a href="https://bvdaihoccoso2.com.vn/vi/tai-sao-nen-tam-soat-ung-thu-tu-som.html" class="pn-image d-flex"><img class="lazyload lazy-loaded" src="https://bvdaihoccoso2.com.vn/uploads/bai-viet/kien-thu-y-khoa/tamsoatungthu-190x110.jpg" alt="Tại sao nên tầm soát ung thư từ sớm?"></a>
                        <a href="https://bvdaihoccoso2.com.vn/vi/tai-sao-nen-tam-soat-ung-thu-tu-som.html" class="pn-name limit-two-line d-flex fs-5" title="Tại sao nên tầm soát ung thư từ sớm?">Tại sao nên tầm soát ung thư từ sớm?</a>
                      </div>
                    <div class="pn-item clearfix mb-3 d-flex justify-content-center" >
                        <a href="https://bvdaihoccoso2.com.vn/vi/te-bi-chan-tay-nguyen-nhan-trieu-chung.html" class="pn-image"><img class="lazyload lazy-loaded" src="https://bvdaihoccoso2.com.vn/uploads/bai-viet/kien-thu-y-khoa/te-bi-chan-tay-layout-190x110.jpg" alt="TÊ BÌ CHÂN TAY: Nguyên nhân - Triệu chứng"></a>
                        <a style="display: inline-block;" href="https://bvdaihoccoso2.com.vn/vi/te-bi-chan-tay-nguyen-nhan-trieu-chung.html" class="pn-name limit-two-line fs-5" title="TÊ BÌ CHÂN TAY: Nguyên nhân - Triệu chứng">TÊ BÌ CHÂN TAY: Nguyên nhân - Triệu chứng</a>
                    </div>
                          </div>
                    <div class="text-center me-2 p-3" ><a href="https://bvdaihoccoso2.com.vn/vi/chuyen-muc/kien-thuc-y-khoa.html" class="pn-more no-underline fs-5"><button>Xem tất cả</button> </a></div>
                </div>
                  <div class="pn-share" >
                    <h5 class="pn-title">
                        <img src="./public/img/tim.png">
                        <a href="javascript:;">Góc tri ân</a>
                    </h5>
