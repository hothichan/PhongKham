<div class="d-flex justify-content-center align-items-center min-vh-100 box-area2 " style="font-family:'Edu NSW ACT Foundation';">
    <div class="row border rounded-2 p-0 bg-while shadow box-area3  ">
        <h3><b>Tin tức ưu đãi</b></h3>
        <br>

        <div class="col rounded-4 d-flex  flex-column mb-3 left-box me-2" style="background: #4c97ba;">
        ...
        <div class="link-product" style="text-align: center;">
            <a href="#" class="all-product">Xem tất cả</a>
        </div>
        <br>
        <h3><b>Tin tức về phòng khám</b></h3>
        <div class="col rounded-4 d-flex justify-content-center align-items-center flex-column mb-3 left-box me-3" style="background: #4c97ba;">
            <div class="featured-image mb-3" style="line-height: 1.2">
                <a href="index.php?controller=news&action=chitietdieuduong" class="no-underline" style="display: inline-block;">
        ...
        <div class="col rounded-4 d-flex justify-content-center align-items-center flex-column mb-3 left-box me-3" style="background: #4c97ba;">
            <div class="featured-image mb-3" style="line-height: 1.2">
                <a href="index.php?controller=news&action=chitietdieuduong" class="no-underline" style="display: inline-block;">
                    <img src="./public/img/news/t8.jpg" class="img-fluid mt-2" style="width:250px; height: 200px;">
                </a>
                <a href="index.php?controller=news&action=chitietdieuduong" class="no-underline" style="display: inline-block;">
        ...
        <div class="col rounded-4 d-flex justify-content-center align-items-center flex-column mb-3 left-box me-3" style="background: #4c97ba;">
            <div class="featured-image mb-3" style="line-height: 1.2">
                <a href="CtttTuyenDungDieuDuong.html" class="no-underline" style="display: inline-block;">
                    <img src="./public/img/news/ttdd.jpg" class="img-fluid mt-2" style="width:250px; height: 200px;">
                </a>
                <a href="CtttTuyenDungDieuDuong.html" class="no-underline" style="display: inline-block;">
